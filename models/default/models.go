...
type WallDaily struct {
	...
	Guid     string    `json:"guid" form:"guid" xorm:"notnull default '' comment('bing.wilii.cn原始ID') CHAR(10)"`
	...
	Color    string    `json:"color" form:"color" xorm:"notnull default '' comment('主色调') VARCHAR(15)"`
